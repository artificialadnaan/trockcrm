-- Migration 0119: follow-up for 0118 to ensure Life Safety reassertion always runs
-- and tenant normalization only targets literal office_ schemas.
...
BEGIN
  ...
  RAISE NOTICE '0119_unanswered_placeholder_life_safety_followup: updated % life_safety node rows', affected_count;
  ...
  LOOP
    ...
    GET DIAGNOSTICS affected_count = ROW_COUNT;
    RAISE NOTICE '0119_unanswered_placeholder_life_safety_followup: normalized % rows in %', affected_count, schema_name_var;
  END LOOP;
END $$;
