...
-- server/src/migrations/runner.ts prebuilds this CONCURRENTLY outside this file's implicit
-- transaction, including recovery of invalid interrupted builds; this declaration then no-ops.
DO $$ BEGIN
IF to_regclass('public.job_queue_service_rfp_history_idx') IS NULL THEN
