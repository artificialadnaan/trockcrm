...
const styles = StyleSheet.create({
  ...
  name: { ...theme.type.h1, color: theme.color.textPrimary, marginTop: theme.space.sm },
  ...
  amount: { ...theme.type.h2, color: theme.color.textPrimary },
  ...
  moveText: { ...theme.type.body, color: theme.color.redText },
  watchBtn: {
  ...
  watchText: { ...theme.type.label, color: theme.color.textPrimary },
  ...
  contactLabel: { ...theme.type.body, color: theme.color.textSecondary },
  linkError: { ...theme.type.label, color: theme.color.redText },
  rowValue: { flexShrink: 1, textAlign: "right", ...theme.type.body, color: theme.color.textPrimary },
  ...
  noteError: { ...theme.type.label, color: theme.color.redText },
  watchError: {
  ...
  staleText: { ...theme.type.label, color: theme.color.amberText },
  saveNote: {
  ...
  saveNoteText: { ...theme.type.body, color: theme.color.textInverse },
  retry: {
    borderWidth: 1,
    borderColor: theme.color.border,
    borderRadius: theme.radius.md,
  ...
  emptyActivity: { ...theme.type.body, color: theme.color.textMuted },
  ...
  activityMeta: { ...theme.type.caption, color: theme.color.textSecondary },
  activitySubject: { ...theme.type.body, color: theme.color.textPrimary },
  activityNotes: { ...theme.type.body, color: theme.color.textSecondary },
  ...
  backBtnText: { ...theme.type.body, color: theme.color.textPrimary },
});
