...
const styles = StyleSheet.create({
  ...
  subtitle: { ...theme.type.body, color: theme.color.textSecondary },
  label: {
  ...
  help: { ...theme.type.label, color: theme.color.textMuted },
  ...
  stageOptionText: { ...theme.type.label, color: theme.color.textSecondary },
  ...
  checkingText: { ...theme.type.label, color: theme.color.textMuted },
  verdictBox: {
  ...
  blockTitle: { ...theme.type.body, color: theme.color.amberText },
  warnTitle: { ...theme.type.body, color: theme.color.amberText },
  okTitle: { ...theme.type.body, color: theme.color.green },
  blockBody: { ...theme.type.body, color: theme.color.textSecondary },
  missingWrap: { marginTop: theme.space.sm, gap: 2 },
  missingItem: { ...theme.type.label, color: theme.color.textSecondary },
  input: {
  ...
  error: { marginTop: theme.space.md, ...theme.type.label, color: theme.color.redText },
  primary: {
  ...
  primaryText: { ...theme.type.body, color: theme.color.textInverse },
  secondary: {
    borderWidth: 1,
    borderColor: theme.color.border,
    borderRadius: theme.radius.md,
  ...
  secondaryText: { ...theme.type.body, color: theme.color.textPrimary },
});
