...
const styles = StyleSheet.create({
  ...
  callText: { ...theme.type.label, color: theme.color.redText },
  center: { flex: 1, alignItems: "center", justifyContent: "center", padding: theme.space.xl, gap: theme.space.sm },
  emptyTitle: { ...theme.type.h2, color: theme.color.textPrimary },
  emptyBody: { ...theme.type.body, color: theme.color.textSecondary, textAlign: "center" },
});
