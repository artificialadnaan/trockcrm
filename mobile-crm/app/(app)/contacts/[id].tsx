...
const styles = StyleSheet.create({
  ...
  jobTitle: { ...theme.type.body, color: theme.color.textMuted },
  ...
  actionText: { ...theme.type.body, color: theme.color.textInverse },
  ...
  emptyBody: { ...theme.type.body, color: theme.color.textMuted },
  ...
  dealName: { flex: 1, ...theme.type.body, color: theme.color.textPrimary },
  // A chevron is a GLYPH, not type: sized to sit optically level with the row it terminates,
  // which no text step happens to match.
