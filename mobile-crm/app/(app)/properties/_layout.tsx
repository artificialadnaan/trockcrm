...
/**
 * Role guard for the properties routes.
 *
 * A bare `Stack` here was an authorisation HOLE, not a stylistic difference: `/properties` is mounted
...
export default function PropertiesLayout() {
  return <SurfaceStack surface="properties" />;
}
