...
export function OpportunityRoutingPanel({
  ...
  deal: {
    ...
    routingHistory: Array<{
      id: string;
      fromWorkflowRoute: "estimating" | "service" | null;
      toWorkflowRoute: "estimating" | "service";
      valueSource: string;
    ...
    <Card>
      <CardHeader>
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Badge variant="outline">{deal.workflowRoute === "service" ? "Service Route" : deal.workflowRoute === "estimating" ? "Deals Route" : "Route Pending"}</Badge>
        </div>
        <CardDescription>
