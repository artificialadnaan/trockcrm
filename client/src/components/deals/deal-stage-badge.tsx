...
const STAGE_COLORS: Record<string, string> = {
  ...
  service_estimating: "bg-slate-100 text-slate-700 border-slate-300",
  estimate_under_review: "bg-lime-100 text-lime-700 border-lime-200",
  ...
  production_lost: "bg-rose-100 text-rose-700 border-rose-200",
