...
any of the three numbers, because a reader who cannot distinguish a stale count from a miscount is
reason enough to stop writing counts beside a check that emits them. Everything else was verified against
