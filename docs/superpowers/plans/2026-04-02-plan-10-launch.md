...
const SECTIONS: AdminSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "SYNCHUB_INTEGRATION_SECRET: Shared secret for SyncHub → CRM opportunity/procore integration pushes using X-SyncHub-Secret.",
      "SYNCHUB_RELAY_SECRET: Bearer secret for the CRM-side SyncHub Procore project relay receiver.",
      "SYNCHUB_SHARED_SECRET: HMAC secret for /api/internal RFP relay requests using x-rfp-request-signature.",
...
- [ ] All Railway env vars set (API service, Worker service, Frontend service)
  - API: `DATABASE_URL`, `JWT_SECRET`, `AZURE_CLIENT_ID`, `AZURE_CLIENT_SECRET`, `AZURE_TENANT_ID`, `PROCORE_CLIENT_ID`, `PROCORE_CLIENT_SECRET`, `PROCORE_COMPANY_ID`, `PROCORE_WEBHOOK_SECRET`, `SYNCHUB_INTEGRATION_SECRET`, `SYNCHUB_RELAY_SECRET`, `SYNCHUB_SHARED_SECRET`, `R2_ACCOUNT_ID`, `R2_ACCESS_KEY_ID`, `R2_SECRET_ACCESS_KEY`, `R2_BUCKET_NAME`, `FRONTEND_URL`, `ENCRYPTION_KEY`, `RESEND_API_KEY`
