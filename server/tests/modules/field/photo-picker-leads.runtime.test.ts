...
beforeAll(async () => {
  ...
  await pg.exec(`
    ...
    CREATE TABLE ${T}.deals (
      id uuid PRIMARY KEY, sales_source_user_id uuid, name text NOT NULL, is_change_order boolean NOT NULL DEFAULT false, deal_number text, project_number text, pipeline_disposition text,
