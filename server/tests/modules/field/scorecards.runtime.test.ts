...
import { fieldScorecards, fieldScorecardItems, fieldScorecardPhotos, scorecardCorrectiveActions, scorecardCorrectiveActionEvents, dealTeamMembers, contacts } from "@trock-crm/shared/schema";
...
beforeAll(async () => {
  ...
  `);
  await pg.exec(tenantSchemaSql("public", [fieldScorecards, fieldScorecardItems, fieldScorecardPhotos, scorecardCorrectiveActions, scorecardCorrectiveActionEvents, dealTeamMembers, contacts]));
  await pg.exec(
