...
beforeAll(async () => {
  ...
  await pg.exec(`
    ...
    CREATE TABLE deals (
      ...
      won_closed_date date, expected_close_date date, bid_due_date timestamptz, actual_close_date date, lost_at timestamptz, contract_signed_date date, contract_signed_at timestamptz, updated_at timestamptz,
