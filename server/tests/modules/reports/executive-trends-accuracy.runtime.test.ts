...
beforeAll(async () => {
  ...
  await pg.exec(`
    ...
    CREATE TABLE deals (
      id uuid PRIMARY KEY, name text, stage_id uuid NOT NULL, assigned_rep_id uuid, estimator_user_id uuid, sales_source_user_id uuid,
      is_active boolean NOT NULL DEFAULT true, is_test_data boolean NOT NULL DEFAULT false, is_change_order boolean NOT NULL DEFAULT false, on_hold boolean NOT NULL DEFAULT false, expected_close_date date, bid_due_date timestamptz, bid_board_stage_slug text,
