...
beforeAll(async () => {
  ...
  await pg.exec(`
    ...
    CREATE TABLE deals (
      ...
      is_change_order boolean NOT NULL DEFAULT false, on_hold boolean NOT NULL DEFAULT false, won_closed_date date, expected_close_date date, bid_due_date timestamptz, bid_board_stage_slug text,
  ...
  beforeAll(async () => {
    ...
    await cpg.exec(`
      ...
      CREATE TABLE deals (
        ...
        is_change_order boolean NOT NULL DEFAULT false, on_hold boolean NOT NULL DEFAULT false, is_active boolean NOT NULL DEFAULT true,
