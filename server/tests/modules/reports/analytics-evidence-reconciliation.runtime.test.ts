...
beforeAll(async () => {
  ...
  await pg.exec(`
    ...
    CREATE TABLE deals (
      ...
      is_active boolean NOT NULL DEFAULT true, is_test_data boolean NOT NULL DEFAULT false, is_change_order boolean NOT NULL DEFAULT false, on_hold boolean NOT NULL DEFAULT false, expected_close_date date, bid_due_date timestamptz,
      ...
      property_city text, property_state text, office_code text, last_activity_at timestamptz, bid_board_stage_slug text,
