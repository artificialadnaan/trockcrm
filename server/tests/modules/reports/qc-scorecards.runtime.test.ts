...
const DEAL_D = "bbbbbbbb-0000-0000-0000-000000000001"; // Dallas
const DEAL_A = "bbbbbbbb-0000-0000-0000-000000000002"; // Atlanta
...
beforeAll(async () => {
  ...
  await pg.exec(`
    ...
    CREATE TABLE deals (id uuid PRIMARY KEY, name text, region_id uuid, project_number text);
  ...
  await pg.exec(`
    ...
    INSERT INTO deals (id, name, region_id, project_number) VALUES
      ('${DEAL_D}','Maple Street Tower','${RC_DALLAS}','DFW-10432'),
      ('${DEAL_A}','Riverbend Logistics','${RC_ATL}','ATL-2207');
  `);
  tdb = drizzle(pg);
