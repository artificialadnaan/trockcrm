...
beforeAll(async () => {
  ...
  await pg.exec(`
    ...
    CREATE TABLE deals (
      ...
      is_change_order boolean NOT NULL DEFAULT false, on_hold boolean NOT NULL DEFAULT false, expected_close_date date, bid_due_date timestamptz, on_hold_started_at timestamptz,
