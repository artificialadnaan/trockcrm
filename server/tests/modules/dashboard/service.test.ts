  ...
  describe("getRepDashboard", () => {
    ...
    it("returns canonical funnel buckets for the rep dashboard", async () => {
      ...
      const tenantDb = createMockTenantDb([
        ...
        [],
        [
          { slug: "lead_new", count: "4" },
          { slug: "contacted", count: "9" },
          { slug: "pre_qual_value_assigned", count: "2" },
          { slug: "qualified_lead", count: "7" },
          { slug: "qualified_for_opportunity", count: "3" },
  ...
  describe("getDirectorDashboard", () => {
    ...
    it("returns office funnel buckets and rep rows in default workload order", async () => {
      ...
      const tenantDb = createMockTenantDb([
        ...
        [
          { slug: "lead_new", count: "5" },
          { slug: "contacted", count: "8" },
          { slug: "pre_qual_value_assigned", count: "3" },
          { slug: "qualified_lead", count: "4" },
          { slug: "qualified_for_opportunity", count: "2" },
          { slug: "director_go_no_go", count: "1" },
