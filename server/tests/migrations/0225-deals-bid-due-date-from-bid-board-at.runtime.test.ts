// Executes migration 0225 FROM DISK against a real Postgres (PGlite).
//
// 0225 adds the PROVENANCE stamp the read resolver requires: `bid_due_date_from_bid_board_at`, set by the
...
const MIGRATION = "0225_deals_bid_due_date_from_bid_board_at";
...
/** The minimum shape 0225 needs: a deals table per office, carrying the two columns the signal reads. */
...
describe("migration 0225 — deals.bid_due_date_from_bid_board_at", () => {
