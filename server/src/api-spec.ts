    ...
    "/api/admin/pipeline/{id}": {
      patch: {
              ...
              schema: {
                ...
                properties: {
                  ...
                  requiredFields: {
                    type: "array",
                    items: { type: "string" },
                    description: "Known deal fields that must be populated before reps can advance without override.",
                  },
                  requiredDocuments: {
                    type: "array",
                    items: { type: "string" },
                    description: "Known file categories that must exist on the deal before reps can advance without override.",
                  },
                  requiredApprovals: {
                    type: "array",
                    items: { type: "string", enum: ["director", "admin"] },
                    description: "Approval roles that must approve the stage move before reps can advance without override.",
                  },
                },
              },
            },
        ...
        responses: {
          ...
          400: { description: "Validation error for an invalid stage-gate payload." },
        },
      },
    },
