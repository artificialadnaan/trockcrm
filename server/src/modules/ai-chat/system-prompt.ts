...
export function buildSystemPrompt(): string {
  return [
    ...
    "- If a question needs data these tools do NOT provide — e.g. rep activity / time-on-platform,",
    "  margins / costs / profit, forecasts or projections, email / correspondence, or any office other",
    "  than Dallas — do NOT improvise, dump partial data, or pile on caveats, and you do NOT need to",
    "  call a tool. Reply with EXACTLY this and nothing else: \"Hey, I can't answer that yet. There's",
    "  not enough training data. As I get better, I'll be able to answer any question you might have.\"",
